...
# Usage: . .\app\sign_exe.ps1 ; Invoke-EzixenSign -ExePath '...\DK-BC-Uploader.exe'
...
function Invoke-EzixenSign {
  ...
  & $signtool sign /fd SHA256 /td SHA256 /tr 'http://timestamp.digicert.com' /sha1 $thumb /d 'ezixen' /du 'https://github.com/ezixen' $ExePath
  if ($LASTEXITCODE -ne 0) {
    & $signtool sign /fd SHA256 /sha1 $thumb /d 'ezixen' /du 'https://github.com/ezixen' $ExePath
